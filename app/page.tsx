...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div style={{width: 242, height: 46, left: 657, top: 34, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 30, fontFamily: 'Roboto Mono', fontWeight: '700', wordWrap: 'break-word'}}><a href="upload.tsx">อัพโหลดไฟล์</a></div>
